...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '917994128839-1632403322@g.us',
    ...
    BOT_INFO: process.env.BOT_INFO || 'sᴀᴛʜᴀɴɪᴄ;https://ik.imagekit.io/eypz/1728233394984_sMdJYvA_i.png',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "sᴀᴛʜᴀɴɪᴄ",
    BOT_NAME: process.env.BOT_NAME || 'sᴀᴛʜᴀɴɪᴄ',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝐒𝐀𝐓𝐇𝐀𝐍𝐈𝐂¹¹ꫂ;Sᴀᴛʜᴀɴɪᴄ ᴀᴜᴅɪᴏs;https://ik.imagekit.io/eypz/1728233394984_sMdJYvA_i.png' : process.env.AUDIO_DATA,
